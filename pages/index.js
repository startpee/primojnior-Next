    ...
    <>
      <div className="landing-page-container">
        ...
        <div className="landing-page-top-container">
          <nav data-role="Header" className="landing-page-navbar">
            ...
            <div className="landing-page-right-side">
              <div className="landing-page-links-container">
                <a
                  href="http://primojunior.com/"
                  className="landing-page-link01"
                >
                  Inicio
                </a>
                <span className="landing-page-text">Sobre</span>
                <a
            ...
            <div data-role="MobileMenu" className="landing-page-mobile-menu">
              <div className="landing-page-nav">
                ...
                <div className="landing-page-right-side1">
                  <div className="landing-page-links-container1">
                    <Link href="/">
                      <a className="landing-page-link05">Pagina inicial</a>
                    </Link>
                    <span className="landing-page-text01">Quem eu sou</span>
              ...
              <div className="landing-page-follow-container">
                <span className="landing-page-text04">Segui o primo</span>
          ...
          <div className="landing-page-hero">
            <div className="landing-page-content-container">
              <img
                src="/playground_assets/11%20%5B1%5D-600h.png"
                alt="image"
                className="landing-page-image"
              />
              <span className="landing-page-text05 Subheading">
                Em breve vou lançar um app chamado start para empreender
              </span>
              <a
        ...
        <div className="landing-page-div">
          <DangerousHTML
            html={`<storifyme-collection url="https://stories.storifyme.com/widgets/g-francisco-junior-49065/widget/custom/6949">
        ...
        <div className="landing-page-div1">
          <DangerousHTML
            html={`<iframe style="border-radius:12px" src="https://open.spotify.com/embed/show/0LzVGwtBYHnWAByDNLNn3b?utm_source=generator"
          ...
          <div className="landing-page-menu">
            ...
            <div className="landing-page-links-container2">
              ...
              <div className="landing-page-container2">
                ...
                <Link href="/chat">
                  <a className="landing-page-link16">Contato</a>
                </Link>
              </div>
            </div>
